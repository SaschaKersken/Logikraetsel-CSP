...
public class Houses implements Constraint<String, HouseRecord> {
    ...
    */
    ...
    public boolean check(Map<String, HouseRecord> assignment) {
        ...
        if (assignment.containsKey("Daniel") && assignment.containsKey("Ben")) {
            if (Math.abs(assignment.get("Daniel").getNumber() - assignment.get("Ben").getNumber()) == 2) {
                return false;
            }
        }
        ...
        if (assignment.containsKey("Ben")) {
            HouseRecord hector = assignment.get("Ben");
        ...
        if (assignment.containsKey("Camilla") && assignment.get("Camilla").getAge() == 39) {
            return false;
        }
        ...
        if (assignment.containsKey("Anna") && assignment.containsKey("Daniel")) {
            if (assignment.get("Anna").getNumber() != 4 && assignment.get("Daniel").getNumber() != 4) {
                return false;
            }
        }
    ...
    */
    public static void main(String[] args) {
        ...
        List<String> variables = Arrays.asList("Anna", "Camilla", "Ben", "Daniel");
